...
class _LegacySignalMeasurementLoader:
    """Lazy loader for LegacySignalMeasurement to avoid circular import"""
    _cached = None
    
    def __call__(self, *args, **kwargs):
        if self._cached is None:
            from .devices.legacy.measurements.signal_measurement import SignalMeasurement
            _LegacySignalMeasurementLoader._cached = SignalMeasurement
        return self._cached(*args, **kwargs)

LegacySignalMeasurement = _LegacySignalMeasurementLoader()
...
class MeasurementType():
    ...
    LEGACY_SIGNAL = LegacySignalMeasurement