...
from model.config_model import GRU_CONFIG
...
def main():
    ...
    run_dir = results_dir / f"sweep_gru_{timestamp}"
    ...
    param_grid = {
        ...
        'batch_size': [16, 32, 64],
        'epochs': [50, 100]  # Kept lower for sweep to save time, or 100
    }
    ...
    window_size_sec = GRU_CONFIG.get('window_size_sec', 0.25)
    window_step_sec = GRU_CONFIG.get('window_step_sec', 0.1)
    ...
    with open(report_file, "w") as f:
        f.write("GRU HYPERPARAMETER SWEEP REPORT\n")
        f.write("="*50 + "\n\n")
    ...
    # Save best model
    model_path = run_dir / "best_gru_model.joblib"
